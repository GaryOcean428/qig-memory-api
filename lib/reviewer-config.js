...
// Default xAI Grok model, routed through the Vercel AI Gateway (AI_GATEWAY_API_KEY).
// Matches the helper agent so we only ever depend on one model id.
export const DEFAULT_REVIEW_MODEL = 'xai/grok-4.5';
