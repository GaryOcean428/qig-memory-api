...
export const DOCTRINE_SOURCES = [
  ...
  // The old `integrity_dashboard` versioned_doc source (docs/dashboard/
  // certified-vs-retired) was RETIRED 2026-07-18: its certified-vs-retired content
  // is now the structured integrity_registry + retired_registry sources consumed by
  // buildIntegrityView (the /integrity page). The markdown was archived in
  // qig-verification; keeping the glob would fail-loud a spurious source error once
  // it's gone. Consumers of state.canon.integrity_dashboard all null-guard.
  {
