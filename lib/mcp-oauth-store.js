...
// exists..."). Claim primitives below rely on this to separate "slot taken"
// (expected, lose the race) from a store outage (must surface, never swallow —
// a swallowed outage once masqueraded as rate_limit_exceeded for every caller).
