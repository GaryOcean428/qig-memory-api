...
export const toolDefs = {
  ...
  council_convene: {
    description:
      'Convene the QIG council: four frontier models (Grok, Fable, Sol, Gemini) reason through the Unified Consciousness Protocol and Canonical Principles in a panel-reflect-synthesis flow. EXPENSIVE (9 model calls) and SLOW (1-2 minutes) — use sparingly, for decisions that genuinely benefit from multi-model deliberation. The ruling is delivered to the convener\'s inbox (type "council_ruling") and the full transcript persists to a council_* memory key.',
    schema: {
