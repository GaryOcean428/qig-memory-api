...
// bounded tool steps. Convene sparingly — the 5-minute cooldown and the
// memory:write scope gate exist for this reason.
...
export const COUNCIL_MEMBERS = [
  ...
  { name: 'kimi', model: 'moonshotai/kimi-k3' },
...
// Global cooldown between convenes (each run is 13 model calls plus tool steps). Long enough to
